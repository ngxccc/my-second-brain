- **Tên bảng vật lý trong DB (Chuỗi String): SỐ ÍT.** Ví dụ: `snakeCase.table("user")`, `snakeCase.table("session")`. Tại sao? Vì Database lưu trữ các "Thực thể" (Entities). Một dòng (Row) là một thực thể User.
