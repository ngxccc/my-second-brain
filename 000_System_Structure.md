...
* **`00_Dashboard.md.md`**: Dashboard chính hiển thị các task tồn đọng trong 7 ngày gần nhất sử dụng `dataviewjs`.
...
* **Các thư mục con:**
    * `Daily_Logs/`: Nhật ký, log công việc hàng ngày (Ví dụ: `2026-06-07.md`). Sử dụng template `Daily_Log_Template.md.md` để tạo mới hàng ngày.
...
* **Thư mục con hiện tại:**
    * `Templates/`: Các file mẫu để tạo note nhanh chóng (`Daily_Log_Template.md.md`, `Technical_Concept_Template.md`, `Project_Template.md`...).
* **Thư mục dự kiến (khi cần):** `Attachments/` (chứa hình ảnh, file đính kèm), `Scripts/` (Dataview scripts, custom CSS).
