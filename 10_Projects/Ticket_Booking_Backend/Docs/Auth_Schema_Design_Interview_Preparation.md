...
*   **Điểm phỏng vấn cần nhấn mạnh:**
    ...
    *   *Trade-off (Sự đánh đổi):* Nếu sau này hệ thống mở rộng hỗ trợ thêm nhiều nhà cung cấp OAuth khác (Apple, Github, Discord...), chúng ta bắt buộc phải chạy migration để bổ sung thêm cột vào bảng chính thay vì chỉ chèn dữ liệu động như mô hình tách bảng (Separated Auth Providers).
