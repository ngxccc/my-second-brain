---
tags: [type/concept, topic/psychology, topic/learning, topic/decision-making]
date: 2026-07-15
aliases:
  [
    Cognitive Stack Framework,
    Hệ thống phân cấp tư duy,
...
```mermaid
graph TD
    L5[Tầng 5: Quyết định & Hành động - Decision & Execution] --> L4[Tầng 4: Sáng tạo & Đột phá - Innovation & Divergence]
    L4 --> L3[Tầng 3: Tổng hợp & Hệ thống - Synthesis & Systems]
    L3 --> L2[Tầng 2: Truy vấn & Phân tách - Inquiry & Deconstruction]
    L2 --> L1[Tầng 1: Trực giác & Lọc nhiễu - Intuition & Bias Filtering]
```
