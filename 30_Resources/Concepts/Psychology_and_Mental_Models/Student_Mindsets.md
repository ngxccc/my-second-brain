...
- **STAR Method (Phương pháp STAR):** Khi làm đồ án, bài tập lớn hay hoạt động ngoại khóa, hãy cấu trúc công việc và cách trình bày CV theo chuẩn: **S**ituation (Bối cảnh) $\rightarrow$ **T**ask (Nhiệm vụ) $\rightarrow$ **A**ction (Hành động của bạn) $\rightarrow$ **R**esult (Kết quả định lượng được).

---

## Practical Implementation

Để đưa các tư duy trên vào thực tế cuộc sống sinh viên hàng ngày:

1. **Quản lý thời gian bằng Time Blocking:** Chia thời gian trong ngày thành các khối cố định (ví dụ: 2 tiếng buổi sáng học thuật toán, 1 tiếng buổi chiều tự học tiếng Anh). Khi đang ở trong một "khối", tuyệt đối không kiểm tra mạng xã hội.
2. **Xây dựng Portfolio từ sớm:** Thay vì chỉ lấy điểm số trên lớp, hãy làm các dự án cá nhân (side projects) dựa trên tư duy nguyên bản và đưa lên GitHub. Viết tài liệu (README) giải thích dự án theo phương pháp STAR. Đây là tấm vé vàng khi đi xin việc.
3. **Tích lũy vốn kỹ năng mềm:** Luyện tập kỹ năng giao tiếp, viết lách và làm việc nhóm thông qua các bài thuyết trình trên lớp. Kỹ năng giao tiếp tốt kết hợp với chuyên môn vững sẽ nhân đôi cơ hội sự nghiệp của bạn.
4. **Thiết lập bộ lọc thông tin:** Hạn chế tiêu thụ các nội dung ngắn, giật gân (TikTok, Facebook Reels) vì chúng tàn phá sự tập trung dài hạn cần thiết cho việc học sâu. Ưu tiên đọc sách, viết blog và ghi chép có hệ thống.

---

**Related Notes:**

- Bản đồ khái niệm cốt lõi: [[000_Concepts_MOC]]
- Phương pháp bóc tách vấn đề từ gốc: [[First_Principles_Thinking]]
- Chiến thuật tích sản định kỳ: [[Dollar_Cost_Averaging]]
- Phương pháp viết CV và phỏng vấn kỹ thuật: [[STAR_Method_Tech]]
- Thuật toán lặp lại ngắt quãng: [[Spaced_Repetition_SM2]]
- Bản chất và giới hạn của các mô hình tư duy: [[Critical_Thinking_Models]]
- Công thức quản lý quy mô vốn tối ưu: [[Kelly_Criterion]]
